...
class Customers: NSObject {
    ...
    func get(completion: @escaping (() -> Void)) {
        ...
        let soqlQuery = "SELECT Id, Name, Email__c, Address__c, City__c, State__c, Zip__c, LastModifiedDate FROM CM_Customer__c WHERE Address__c != '' ORDER BY LastModifiedDate DESC LIMIT 15"
